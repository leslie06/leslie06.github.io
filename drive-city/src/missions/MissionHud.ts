...
const CSS = `
.hud .cash{position:absolute;top:calc(var(--hud-y) + 40px);right:var(--hud-x);font:800 24px/1 ${F.ui};font-variant-numeric:tabular-nums;letter-spacing:.02em;
...
.hud .cash-add{position:absolute;top:calc(var(--hud-y) + 70px);right:var(--hud-x);font:700 17px/1 ${F.ui};color:#a6e38f;text-shadow:0 1px 0 rgba(0,0,0,.75)}
