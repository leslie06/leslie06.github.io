 ...
 */
export const LANDMARKS: LandmarkDef[] = [tiananmen, zhengyangmen, jianlou, qiniandian, huanqiu, cwtc3, citic, cctv, monument, station, wumen, taihedian, huangqiongyu, happyValley];
